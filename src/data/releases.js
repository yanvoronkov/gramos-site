...
const RELEASES = [
  {
    ...
    summary: 'Масштабное обновление визуального конструктора автоворонок: появился двухрежимный холст для обзора связей между всеми сценариями проекта, интеллектуальное автовыравнивание Dagre, плавное перетаскивание карточек с анимацией FLIP, поддержка мобильных свайпов для быстрых действий и автоматическая привязка основного бота к массовым рассылкам.',
    changes: [
      {
        category: 'Сценарии и визуальный холст',
        tag: 'feat',
        items: [
          'Двухрежимный холст: мгновенное переключение между детальным редактированием одной воронки и обзорной картой связей всех сценариев проекта.',
          'Автовыравнивание Dagre: аккуратное выстраивание структуры связей по сетке с сохранением пользовательских координат.',
          'Плавный drag-and-drop: бесшовное перемещение карточек с физикой FLIP без зависаний и скачков.',
          'Мобильные свайп-действия: быстрое копирование, отключение или удаление карточек свайпом с телефона.'
        ]
      },
      {
        ...
        tag: 'feat',
        items: [
          'Основной бот по умолчанию: автоматический выбор ключевого бота проекта в качестве отправителя при создании рассылок.',
          'Комплексные фильтры: гибкие комбинации условий по тегам, купленным продуктам, активности и CRM-полям.',
          'Мгновенная оценка: предварительный точный расчёт размера аудитории перед стартом кампании.'
        ]
      },
      {
        ...
        tag: 'fix',
        items: [
          'Устранено мерцание карточек при сбросе (drop) за счет точечной синхронизации рендера с flushSync.',
          'Улучшена изоляция z-index для выпадающих меню и мобильных шторок инспектора.'
        ]
      }
    ]
  },
